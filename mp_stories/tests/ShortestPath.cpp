...
TEST_CASE("Graph::shortestPath finds a shortest path with two vertices", "[weight=2][part=3]") {
...
TEST_CASE("Graph::shortestPath finds a shortest path with three vertices", "[weight=2][part=3]") {
  Graph<Vertex, Edge> g = createTestGraph_shortestPath();
...
TEST_CASE("Graph::shortestPath finds a shortest path with four vertices", "[weight=2][part=3]") {
  Graph<Vertex, Edge> g = createTestGraph_shortestPath();
...
TEST_CASE("Graph::shortestPath finds a shortest path with four vertices (reverse)", "[weight=2][part=3]") {
  Graph<Vertex, Edge> g = createTestGraph_shortestPath();
...
TEST_CASE("Graph::shortestPath finds a shortest path with five vertices", "[weight=2][part=3]") {
  Graph<Vertex, Edge> g = createTestGraph_shortestPath();
...
TEST_CASE("Graph::shortestPath finds a shortest path with six vertices", "[weight=2][part=3]") {
  Graph<Vertex, Edge> g = createTestGraph_shortestPath();
